...
export default function LawyerLogin() {
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    alert('Lawyer login (placeholder)');
  };
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center bg-gray-50 p-6">
        <div className="w-full max-w-md bg-white rounded shadow p-6">
          <h1 className="text-2xl font-semibold mb-4">Lawyer Login</h1>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <button className="bg-purple-600 text-white px-4 py-2 rounded">Sign in</button>
